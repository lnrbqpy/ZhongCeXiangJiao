...
import hznj.com.zhongcexiangjiao.MainActivity;
import hznj.com.zhongcexiangjiao.R;


public class PatternLockLoginActivity extends Activity {
		...
		lpwv.setOnCompleteListener(new PatternLockPassWordView.OnCompleteListener() {
			...
			public void onComplete(String mPassword) {
				...
				if (lpwv.verifyPassword(mPassword)) {
					showToast("登陆成功！");
					Intent intent = new Intent(PatternLockLoginActivity.this,
							MainActivity.class);
					// 打开新的Activity
	...
	/*	Button userLoginButton = (Button) this.findViewById(R.id.userLoginButton);
