...
public class ListAdapter_sq_mx extends BaseAdapter {
    ...
    public ListAdapter_sq_mx(Context context, List<sqmxBean.ListBean> list) {
        this.list =list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListAdapter_sq_mx.ViewHolder holder;

        if (convertView == null){
            convertView = minflater.inflate(R.layout.listview_sq_cx, null);
            holder = new ListAdapter_sq_mx.ViewHolder();
            ...
            holder = (ListAdapter_sq_mx.ViewHolder) convertView.getTag();
        }
        ...
        //holder.renwu.setBackgroundResource(R.color.colorPrimary);
