...
public class ListAdapter_sq_jc extends BaseAdapter {
    private Context context;
    List<sqjcBean.ListBean> list;
    private static String YOURENWU   = "1"; //huangse
    private static String ZHENGCHANG = "2"; //lvse
    private static String YICHANG    = "3"; //hongse

    public ListAdapter_sq_jc(Context context, List<sqjcBean.ListBean> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListAdapter_sq_jc.ViewHolder holder;

        if (convertView == null) {
            convertView = minflater.inflate(R.layout.listview_sq_cx, null);
            holder = new ListAdapter_sq_jc.ViewHolder();
            ...
            holder = (ListAdapter_sq_jc.ViewHolder) convertView.getTag();
        }
