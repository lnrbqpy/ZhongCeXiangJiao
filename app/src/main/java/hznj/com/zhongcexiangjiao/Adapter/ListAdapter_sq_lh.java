...
public class ListAdapter_sq_lh extends BaseAdapter {
    private Context                 context;
    List<sqlhBean.ListBean> list;
    private static String YOURENWU   = "1"; //huangse
    private static String ZHENGCHANG = "2"; //lvse
    private static String YICHANG    = "3"; //hongse

    public ListAdapter_sq_lh(Context context, List<sqlhBean.ListBean> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListAdapter_sq_lh.ViewHolder holder;

        if (convertView == null) {
            convertView = minflater.inflate(R.layout.listview_sq_cx, null);
            holder = new ListAdapter_sq_lh.ViewHolder();
            ...
            holder = (ListAdapter_sq_lh.ViewHolder) convertView.getTag();
        }
