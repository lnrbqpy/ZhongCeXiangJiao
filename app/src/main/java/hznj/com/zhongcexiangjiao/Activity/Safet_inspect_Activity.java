...
public class Safet_inspect_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private             String targetUrl         = "http://171.188.42.56:8081/app/models/Uploadpicture.aspx";
    ...
    public void getSeverFromData1() {
        if (name.getText().equals("")) {
            new AlertDialog.Builder(this).setTitle("加载异常").setMessage("请选择问题设备")
                    .setPositiveButton("确定", null).show();
            return;
        } else if (position1 == 0) {
            new AlertDialog.Builder(this).setTitle("加载异常").setMessage("请选择设备和出错原因")
                    .setPositiveButton("确定", null).show();
            return;
        }
        Retrofit retrofit = new Retrofit.Builder()
    ...
    private Callback getCallback() {
        return new Callback() {
            ...
            public void onResponse(Call call, Response response) {
                Toast.makeText(getApplicationContext(), "设备问题提交成功", Toast.LENGTH_SHORT).show();
                finish();
            }
